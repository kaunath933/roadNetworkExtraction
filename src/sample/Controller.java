...
import sample.Thining.Thinning;
    ...
    public void setThreshold_button()
    {
        ...
        for(int i=0; i<grayScale_buff.getWidth(); i++)
        {
            for(int j=0; j<grayScale_buff.getHeight(); j++)
            {
                ...
                //Color color = grayScale_buff.get()
...
*/
    ...
    public void thining()
    {
        ...
        //int output[][] = thinningService.doZhangSuenThinning(input,false);
